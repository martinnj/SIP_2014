% Solution for part 4.3 of Assignment 6.
...
% Show results.
h1 = figure(643); set(h1,'Color','White');
...
legend('X','Y','Affine X','Location','northwest'); grid on; axis image;
title('Affine transformation of X unto Y','FontSize',14); set(gca,'TickDir','out');