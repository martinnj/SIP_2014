% Solution for part 3 of Assignment 5.
...
I1r = fbackprojection(I1s, 180);
I2r = fbackprojection(I2s, 180);
I3r = fbackprojection(I4, 180);



h = figure(531); set(h,'Color','White'); colormap(bone);
% For box.png.
...
title('box.png filtered backprojection','FontSize',14);
...
title('NCPS filtered backprojection','FontSize',14);
...
title('sinogram.png filtered backprojection','FontSize',14);